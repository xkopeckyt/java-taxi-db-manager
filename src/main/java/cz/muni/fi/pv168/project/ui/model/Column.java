...
class Column<E, T> {
    ...
    private Column(String name, Class<T> columnClass, Function<E, T> valueGetter, BiConsumer<E, T> valueSetter, TableCellRenderer cellRenderer) {
    ...
    public static <E, T> Column<E, T> editable(String name, Class<T> columnClass, Function<E, T> valueGetter,
                                               BiConsumer<E, T> valueSetter, TableCellRenderer cellRenderer) {
        return new Column<>(name, columnClass, valueGetter,
                Objects.requireNonNull(valueSetter, "value setter cannot be null"), cellRenderer);
    }

    public static <E, T> Column<E, T> editable(String name, Class<T> columnClass, Function<E, T> valueGetter,
                                               BiConsumer<E, T> valueSetter) {
        return editable(name, columnClass, valueGetter, valueSetter, null);
    }

    public static <E, T> Column<E, T> readonly(String name, Class<T> columnClass, Function<E, T> valueGetter) {
        return readonly(name, columnClass, valueGetter, null);
    }

    public static <E, T> Column<E, T> readonly(String name, Class<T> columnClass, Function<E, T> valueGetter, TableCellRenderer cellRenderer) {
        return new Column<>(name, columnClass, valueGetter, null, cellRenderer);
    }
