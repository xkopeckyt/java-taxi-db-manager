...
public class CommonDependencyProvider implements DependencyProvider {
    ...
    public CommonDependencyProvider(DatabaseManager databaseManager) {
        ...
        var templateMapper = new TemplateMapper(departmentDao, departmentMapper);
        ...
        templateCrudService = new TemplateCrudService(templateRepository, templateValidator, guidProvider);
    ...
    @Override
    public Repository<Template> getTemplateRepository() {return templateRepository;}
    ...
    @Override
    public CrudService<Template> getTemplateCrudService() {return templateCrudService;}
    ...
    @Override
    public TemplateValidator getTemplateValidator() {return  templateValidator;}
}
